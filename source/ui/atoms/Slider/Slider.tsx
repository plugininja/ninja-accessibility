...
import { IconButton, SelectBox } from "~/ui/molecules";
...
const Slider: React.FC<SliderProps> = ({
    ...
    unitValue = [],
    defaultUnit = "",
    unitPlaceholder = __("Unit", "ninja-accessibility"),
    trackDisabled = false,
    disabled = false,
    onlyInput = false,
    onChange,
