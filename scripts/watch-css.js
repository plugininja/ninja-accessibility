...
const postcssCfg  = path.join(distDir, "postcss.config.cjs");
const loadPath    = path.join(distDir, "node_modules");
...
const sass = spawn(sassBin, ["--watch", sassIn + ":" + cssOut, "--style=expanded", "--load-path=" + loadPath, "--silence-deprecation=import"],
